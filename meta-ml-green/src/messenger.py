...
class Messenger:
    ...
    async def talk_to_agent(
        ...
        Returns:
            Task or str: The agent's response (returns Task object for Message input, string for text input)
        """
        # If message is already a Message object, send it directly
        if isinstance(message, Message):
            async with httpx.AsyncClient(timeout=timeout) as httpx_client:
                ...
                # Return the task for Message objects
